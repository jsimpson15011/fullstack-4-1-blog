...
describe('most blogs', () => {
    ...
    test('when list has one blog return that one', () => {
        ...
        expect(result).toEqual({ author: 'John Test', blogs: 1})
    })
    test('when list has many blogs return the author with the most blogs', () => {
...
describe('most likes', () => {
    ...
    test('when list has one blog return that one', () => {
        ...
        expect(result).toEqual({ author: 'John Test', likes: 5})
    })
    test('when list has many blogs return the author with the most blogs', () => {
